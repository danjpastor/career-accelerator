...
class DuckDBExercisesWidget(QWidget):
    ...
    def _apply_responsive_layout(self) -> None:
        ...
        if mode == "compact":
            ...
            self.navigation_card.setMinimumWidth(190)
            self.navigation_card.setMaximumWidth(235)
            self.main_splitter.setSizes([205, max(430, width - 205)])
            self.workspace_splitter.setSizes([235, 275])
        elif mode == "medium":
            self.main_splitter.setOrientation(Qt.Orientation.Horizontal)
            self.workspace_splitter.setOrientation(Qt.Orientation.Vertical)
            self.navigation_card.setMinimumWidth(240)
            self.navigation_card.setMaximumWidth(330)
            ...
            self.navigation_card.setMinimumWidth(250)
            self.navigation_card.setMaximumWidth(410)
