...
- Added reusable numbered SQL editor with line navigation for parser errors.
- Completed Today’s Focus tasks are muted and struck through.
- Completed Interview Problems now create Demonstrated Evidence records.
- Added automatic backup deduplication and retention pruning.
- Distribution package excludes local virtual environments, backups, caches, databases, and private progress.
