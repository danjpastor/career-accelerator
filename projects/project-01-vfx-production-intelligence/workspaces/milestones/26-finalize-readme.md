...
1. Write a one-sentence value proposition for the project.
2. Explain the business problem, stakeholder, questions, and KPIs.
3. Summarize data, tools, cleaning, validation, and analytical approach.
4. Present quantified findings and recommendations.
5. Add readable visuals and links to final artifacts.
6. Document repository structure and navigation or setup.
7. Disclose synthetic data, assumptions, and limitations.
8. Remove placeholders and test every link from the repository root.
...
Run the publication checklist and test the public repository experience.
...
- [ ] Data source and synthetic-data disclosure where applicable
- [ ] Tools and workflow
- [ ] Data cleaning and validation summary
- [ ] Data model or schema
- [ ] Analysis approach
- [ ] Key findings with quantified evidence
- [ ] Dashboard or output screenshots
- [ ] Recommendations
- [ ] Assumptions and limitations
- [ ] Repository structure
- [ ] Setup or navigation instructions
- [ ] Links to final artifacts

## Employer review test

A reviewer should be able to answer these in two minutes:

1. What business problem did this solve?
2. What work did you personally perform?
3. Which tools and analytical skills did you demonstrate?
4. What were the strongest findings?
5. Where can the final artifact be viewed?
