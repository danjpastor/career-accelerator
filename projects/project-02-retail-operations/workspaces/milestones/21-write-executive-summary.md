...
1. State the business problem and stakeholder decision.
2. Summarize the data and analytical approach without implementation detail.
3. Present three to five validated quantified findings.
4. Prioritize recommendations by impact and feasibility.
5. State assumptions, limitations, and unresolved risks.
6. Link to the dashboard and supporting artifacts.
7. Edit to one page of decision-focused content.
...
Use the summary as the decision-focused narrative in the README and portfolio.
...
**Milestone:** Write executive summary  
**Started:** 2026-07-21
