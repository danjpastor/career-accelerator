...
1. Review the repository for secrets, personal information, and temporary files.
2. Confirm reproducibility, artifact paths, and public links.
3. Test the README and images in the public repository view.
4. Review filenames, commit history, description, and repository topics.
5. Create a clear final commit and version tag or release.
6. Open the public project in a clean browser session.
7. Record any intentionally excluded data or setup requirements.
...
Use the release as the stable employer-facing version of the project.
