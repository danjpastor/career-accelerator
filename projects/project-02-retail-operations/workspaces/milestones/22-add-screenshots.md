...
1. Select only views that help a reviewer understand the project quickly.
2. Set readable dimensions, filters, and zoom.
3. Remove irrelevant application chrome and private information.
4. Capture consistent images with descriptive filenames.
5. Add captions or alt text that explain what each image proves.
6. Reference the correct relative paths from the README.
7. Test readability in the rendered public repository.
...
Use optimized images in the README and portfolio presentation.
...
**Milestone:** Add screenshots  
**Started:** 2026-07-21

## Screenshot plan

| Filename | Artifact/page | What it demonstrates | Crop/size | README location |
|---|---|---|---|---|
|  |  |  |  |  |

## Capture checklist

- [ ] Use readable resolution and zoom.
- [ ] Remove personal notifications, file paths, and unrelated application chrome.
- [ ] Keep a consistent aspect ratio where possible.
- [ ] Capture the strongest overview and one or two useful detail views.
- [ ] Use descriptive filenames.
- [ ] Add captions and alt text in the README.
- [ ] Verify the images render on GitHub.
