...
1. Review only validated tables, charts, and metrics.
2. Prioritize findings by decision impact rather than surprise.
3. Quantify each finding with comparison, segment, and period.
4. Explain business relevance without overstating causality.
5. State the limitation or uncertainty attached to each finding.
6. Recommend a follow-up question or action where justified.
7. Link each insight to a reproducible supporting artifact.
...
Use prioritized validated insights to design dashboard hierarchy and recommendations.
...
**Milestone:** Document insights  
**Started:** 2026-07-21

## Write evidence-based findings

| Priority | Observation | Supporting metric/comparison | Why it matters | Limitation | Recommended action or follow-up |
|---:|---|---|---|---|---|
| 1 |  |  |  |  |  |
...
- Compared with what?
- By how much?
- For which segment or period?
- Why might it matter?
- What can and cannot be concluded?

Avoid vague phrases such as “significant improvement” unless the magnitude or statistical test is provided.
