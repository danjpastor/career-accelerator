...
Spreadsheet work is analyst work when it is structured, reproducible, and validated. In this lesson, you will apply **rows, columns, tables & data types** to a realistic workflow.
