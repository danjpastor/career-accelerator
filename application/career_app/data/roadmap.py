...
WEEKLY_GUIDANCE = {
    ...
    2: (
        ...
        "Continue the current Google Certificate module without allowing it to replace required DataCamp catch-up work.",
    ...
    7: (
        ...
        "Use Google Certificate work as supporting learning while Power BI is the primary DataCamp focus.",
    ...
    10: (
        ...
        "Use DataCamp review and targeted DuckDB lessons only for gaps identified during project work.",
    ...
    11: (
        ...
        "Close any remaining certificate, DataCamp, or practice gaps without displacing portfolio execution.",
    ...
    12: (
        ...
        "Review certificate, DataCamp, and practice notes only where they support final assessment or interview preparation.",
