# Applied Lab 16: Evaluate one A/B test result
...
Calculate the result of one supplied A/B test and make a cautious launch recommendation.
...
1. Read the assignment and restate the goal in one sentence: Calculate the result of one supplied A/B test and make a cautious launch recommendation.
...
1. Calculate sample size and conversion rate for each group.
2. Calculate absolute and relative lift using the taught significance output.
3. Write a recommendation that mentions practical impact and one guardrail or limitation.

### Required output

One experiment summary table. A short launch recommendation.

### Check your work

- Groups are compared over the same period and outcome definition.
- Lift calculations use the control group correctly.
- The recommendation reflects both uncertainty and practical size.
...
1. Verify: Groups are compared over the same period and outcome definition.
2. Verify: Lift calculations use the control group correctly.
3. Verify: The recommendation reflects both uncertainty and practical size.
