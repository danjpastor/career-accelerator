...
Explain a dashboard in five minutes and prepare for likely manager questions.

## Skills you will apply

five-minute walkthrough, narrative order, likely questions, evidence-based answers

## Stage 1: Frame the request and define success

Turn the assignment into a clear analytical question before using a tool. The lab objective is to explain a dashboard in five minutes and prepare for likely manager questions..
...
3. List the concepts you expect to use: five-minute walkthrough, narrative order, likely questions, evidence-based answers.
...
1. Identify the audience, decision, urgency, and level of technical detail that is appropriate.
2. Separate confirmed findings, interpretations, recommendations, assumptions, and limitations.
3. Choose the smallest amount of evidence needed to support the requested decision.
4. Outline the message before drafting so the recommendation follows logically from the evidence.
...
1. Write a five-minute audience-problem-evidence-action-limitations outline. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
2. Choose the three visuals to show first. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
3. Draft three likely stakeholder questions. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
4. Prepare concise evidence-based answers. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
5. Rehearse and revise. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
...
1. Verify this requirement independently: Walkthrough stays within five minutes.. Record how you checked it rather than only stating that it passed.
2. Verify this requirement independently: It explains decisions, not features.. Record how you checked it rather than only stating that it passed.
3. Verify this requirement independently: Answers distinguish fact, inference, and recommendation.. Record how you checked it rather than only stating that it passed.
...
1. Create the required deliverable: Timed walkthrough outline.. Make its purpose, scope, and source clear to a reviewer.
2. Create the required deliverable: Three questions and answers.. Make its purpose, scope, and source clear to a reviewer.
3. Create the required deliverable: Self-review.. Make its purpose, scope, and source clear to a reviewer.
