# Applied Lab 10: Correct one misleading chart and takeaway
...
Repair one misleading visual choice and rewrite the accompanying claim so it accurately reflects the data.
...
1. Read the assignment and restate the goal in one sentence: Repair one misleading visual choice and rewrite the accompanying claim so it accurately reflects the data.
...
1. Identify the chart feature or aggregation that creates a misleading impression.
2. Correct the chart or summary calculation without adding new analysis.
3. Rewrite the takeaway in two sentences and state one limitation.

### Required output

One corrected chart or summary. A revised two-sentence takeaway.

### Check your work

- The corrected visual uses an honest scale and appropriate aggregation.
- The takeaway matches the corrected result.
...
1. Verify: The corrected visual uses an honest scale and appropriate aggregation.
2. Verify: The takeaway matches the corrected result.
3. Verify: The limitation remains visible.
