...
**Skills:** chart scale, cherry-picking, average of averages, annotation, uncertainty

## Scenario

You are the **business stakeholder**. A report uses technically valid numbers to tell a misleading story. You will challenge the framing, repair the evidence, and present a more defensible conclusion.
...
- Corrected chart or redesign.
- Corrected headline and paragraph.
- List of misleading choices.

## Guided workflow

### 1. List misleading visual and statistical choices
...
### 2. Recalculate selectively summarized metrics
...
### 3. Choose an appropriate scale and period
...
### 5. Add a meaningful limitation or annotation
