# Applied Lab 34: Record key assumptions and limitations
...
Create a compact decision log for one analysis using only the assumptions, definitions, and limitations that affect interpretation.
...
1. Read the assignment and restate the goal in one sentence: Create a compact decision log for one analysis using only the assumptions, definitions, and limitations that affect interpretation.
...
1. Record the key metric definition, scope, and exclusion rules.
2. Record two important assumptions or judgment calls.
3. Record two limitations and the decision each could affect.

### Required output

One concise decision and limitations log.
...
1. Verify: Definitions and assumptions are specific enough to reproduce.
2. Verify: Limitations explain their likely effect.
3. Verify: The log avoids general notes unrelated to the analysis.
