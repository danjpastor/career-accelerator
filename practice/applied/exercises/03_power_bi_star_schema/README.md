# Applied Lab 18: Connect a fact table to two dimensions
...
Build a small Power BI model with one fact table, two dimensions, and clear one-to-many relationships.
...
1. Read the assignment and restate the goal in one sentence: Build a small Power BI model with one fact table, two dimensions, and clear one-to-many relationships.
...
1. Identify the grain and key of the fact and dimension tables.
2. Create the two one-to-many relationships with the intended filter direction.
3. Add one validation table or card that proves totals do not duplicate.

### Required output

One small Power BI model. A screenshot or note showing the relationship and validation result.

### Check your work

- Dimension keys are unique.
- Relationships connect dimensions to the fact table at the correct grain.
- The validation total matches the source.
...
1. Verify: Dimension keys are unique.
2. Verify: Relationships connect dimensions to the fact table at the correct grain.
3. Verify: The validation total matches the source.
