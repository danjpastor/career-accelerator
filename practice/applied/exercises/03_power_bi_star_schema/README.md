...
**Skills:** fact and dimension tables, relationships, date table, filter direction

## Scenario

You are the **analytics lead**. The cleaned VFX tables are ready, but the model still needs a clear fact-and-dimension structure. The report must filter consistently across shot and time-entry analysis without accidental many-to-many behavior.
...
### 1. Define the grain of shot and time-entry facts
...
### 2. Create project, artist, department, status, and date dimensions

- Save or capture evidence at this point so you can prove the step was completed before moving to the next one.

**Checkpoint:** The step has a visible artifact or recorded evidence and does not introduce an unexplained row-count or total change.

### 3. Build one-to-many single-direction relationships

- Save or capture evidence at this point so you can prove the step was completed before moving to the next one.

**Checkpoint:** The step has a visible artifact or recorded evidence and does not introduce an unexplained row-count or total change.

### 4. Mark the date table and hide technical fields
