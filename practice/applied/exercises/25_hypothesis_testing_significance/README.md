...
Run one hypothesis test using the supplied groups and explain the result without overstating statistical significance.
...
1. Read the assignment and restate the goal in one sentence: Run one hypothesis test using the supplied groups and explain the result without overstating statistical significance.
...
1. State the null and alternative hypotheses and choose the supplied significance level.
2. Run the appropriate taught test and record the test statistic and p-value.
3. Write a plain-language decision that distinguishes statistical from practical importance.

### Required output

One test result table. A short interpretation with one limitation.

### Check your work

- The hypotheses match the business question.
- The decision uses the chosen significance level.
- The interpretation does not claim proof of causation.
...
1. Verify: The hypotheses match the business question.
2. Verify: The decision uses the chosen significance level.
3. Verify: The interpretation does not claim proof of causation.
