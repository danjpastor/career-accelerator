# Applied Lab 23: Explain one forecast-versus-actual variance
...
Calculate one forecast-versus-actual variance and identify the largest contributor.
...
1. Read the assignment and restate the goal in one sentence: Calculate one forecast-versus-actual variance and identify the largest contributor.
...
1. Calculate absolute and percentage variance for the supplied categories.
2. Rank the categories by contribution to the total difference.
3. Write a three-sentence explanation of the largest driver and one follow-up question.

### Required output

One variance table. A three-sentence explanation.
...
1. Verify: Forecast and actual use the same period and scope.
2. Verify: Variance signs are labeled consistently.
3. Verify: The identified driver matches the contribution calculation.
