# Applied Lab 32: Reconcile one finance total difference
...
Explain one difference between two finance totals using a short, traceable reconciliation.
...
1. Read the assignment and restate the goal in one sentence: Explain one difference between two finance totals using a short, traceable reconciliation.
...
1. Confirm the period, currency, and scope of both totals.
2. Build a small bridge showing the exclusions or categories that explain the difference.
3. Write a three-bullet explanation and one prevention step.

### Required output

One reconciliation bridge. A three-bullet explanation.

### Check your work

- The bridge starts and ends at the supplied totals.
- Every adjustment has a named source or rule.
- The explanation identifies the root scope or grain difference.
...
1. Verify: The bridge starts and ends at the supplied totals.
2. Verify: Every adjustment has a named source or rule.
3. Verify: The explanation identifies the root scope or grain difference.
