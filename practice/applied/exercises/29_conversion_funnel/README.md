...
Build one simple conversion funnel and identify the stage with the largest drop-off.
...
1. Read the assignment and restate the goal in one sentence: Build one simple conversion funnel and identify the stage with the largest drop-off.
...
1. Define the three supplied funnel stages and count distinct users at each stage.
2. Calculate the stage-to-stage conversion rates in one result table.
3. Identify the largest drop-off and write one reasonable follow-up question.

### Required output

One funnel table. A two-sentence drop-off takeaway.

### Check your work

- Users are counted once per stage.
- Rates use the correct preceding-stage denominator.
- The takeaway matches the largest calculated drop-off.
...
1. Verify: Users are counted once per stage.
2. Verify: Rates use the correct preceding-stage denominator.
3. Verify: The takeaway matches the largest calculated drop-off.
