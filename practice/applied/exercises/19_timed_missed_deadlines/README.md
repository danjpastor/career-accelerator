...
**Skills:** rapid scoping, SQL analysis, validation, concise recommendation

## Scenario

You are the **production manager**. You have 30 minutes to identify where deadlines are being missed and provide a concise, validated response. The time limit tests prioritization as much as analysis.
...
- Method or SQL.
- Validation results.
- Manager-ready response.

## Guided workflow

### 1. Write one clarifying question
...
### 2. Define missed deadline and grain
...
### 3. Find the top three causes and contribution
...
### 5. Write a three-sentence conclusion and action
