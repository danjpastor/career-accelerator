...
**Skills:** problem, finding, impact, recommendation, limitation, audience adaptation

## Scenario

You are the **department director**. The analysis is complete, but the stakeholder needs a short memo that states the decision, evidence, limitations, and recommended action without technical clutter.
...
- One-page memo.
- Note on omitted technical detail.

## Guided workflow

### 1. Write five sentences: problem, finding, impact, recommendation, limitation
...
### 2. Expand them into a one-page memo
...
### 3. Use one visual only if it improves the decision
