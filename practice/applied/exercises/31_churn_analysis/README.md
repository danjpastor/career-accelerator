...
churn count, churn rate, beginning population, MRR churn, contraction, expansion, net revenue retention

## Stage 1: Frame the request and define success

Turn the assignment into a clear analytical question before using a tool. The lab objective is to calculate several churn measures with correct denominators and explain why they answer different business questions..
...
3. List the concepts you expect to use: churn count, churn rate, beginning population, MRR churn, contraction, expansion, net revenue retention.
...
1. Define the starting customer and recurring-revenue population. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
2. Calculate churned customers and customer churn rate. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
3. Calculate gross revenue churn and net revenue retention. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
4. Separate full cancellations from contraction and expansion. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
5. Segment churn by plan or acquisition channel. Before you begin, identify which source fields and assumptions this step depends on. Complete the work in a clearly labeled section of the submission, then run a small check that would expose a missing row, duplicate entity, incorrect filter, or mismatched unit.
...
1. Verify this requirement independently: Rates use the beginning-period population.. Record how you checked it rather than only stating that it passed.
2. Verify this requirement independently: Expansion is not subtracted from gross revenue churn.. Record how you checked it rather than only stating that it passed.
3. Verify this requirement independently: The analysis states the measurement period.. Record how you checked it rather than only stating that it passed.
...
1. Create the required deliverable: Churn SQL and metric definitions.. Make its purpose, scope, and source clear to a reviewer.
2. Create the required deliverable: Customer-versus-revenue churn comparison.. Make its purpose, scope, and source clear to a reviewer.
3. Create the required deliverable: Actionable interpretation.. Make its purpose, scope, and source clear to a reviewer.
