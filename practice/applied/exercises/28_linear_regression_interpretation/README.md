...
Fit one simple linear regression and explain the slope, fit, and main limitation in plain language.
...
1. Read the assignment and restate the goal in one sentence: Fit one simple linear regression and explain the slope, fit, and main limitation in plain language.
...
1. Choose the supplied outcome and predictor and inspect their relationship.
2. Fit the model and record the slope, intercept, and R-squared.
3. Write a short interpretation that avoids extrapolation and causal claims.

### Required output

One runnable model script or notebook. A three-sentence interpretation.

### Check your work

- The variables and units are stated.
- The slope interpretation uses the correct units.
- The limitation addresses fit, range, or causality.
...
1. Verify: The variables and units are stated.
2. Verify: The slope interpretation uses the correct units.
3. Verify: The limitation addresses fit, range, or causality.
