...
**Skills:** dependent variable, predictor, slope, intercept, residual, R-squared, extrapolation, coefficient interpretation

## Scenario

You are the **marketing manager**. The team wants a simple model relating marketing activity to an outcome. You will fit a linear regression, evaluate assumptions, and explain the coefficient without overstating causality.
...
### 1. Define the outcome and predictor in business terms
...
### 3. Interpret slope, intercept, and R-squared
...
### 4. Inspect residual patterns and influential observations
...
### 5. Explain why prediction outside the observed range is risky
...
- [ ] Units are included in the coefficient interpretation.
